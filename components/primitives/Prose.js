...
const PROSE = [
  ...
  "[&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-separator [&_blockquote]:pl-4 [&_blockquote]:text-label-2",
  "[&_code]:rounded [&_code]:bg-fill [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-data [&_code]:text-[0.875em]",
  "[&_pre]:my-6 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:bg-bg-grouped [&_pre]:p-4",
  ...
  "[&_th]:border-b [&_th]:border-separator [&_th]:py-2 [&_th]:pr-4 [&_th]:text-left [&_th]:font-semibold",
  "[&_td]:border-b [&_td]:border-separator [&_td]:py-2 [&_td]:pr-4 [&_td]:align-top",
